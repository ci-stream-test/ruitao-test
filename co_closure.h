...
// NOCC:build/header_guard(误报:)
#ifndef __CO_CLOSURE_H__
#define __CO_CLOSURE_H__
// NOCC:whitespace/end_of_line(误报:)
struct stCoClosure_t
{  // NOCC:whitespace/braces(误报:)
public:  // NOCC:whitespace/indent(误报:)
	virtual void exec() = 0;  // NOCC:whitespace/tab(误报:)
};

//1.base
//-- 1.1 comac_argc

// NOCC:whitespace/parens(误报:)
#define comac_get_args_cnt( ... ) comac_arg_n( __VA_ARGS__ )
// NOCC:whitespace/comma(误报:),whitespace/parens(误报:)
#define comac_arg_n( _0,_1,_2,_3,_4,_5,_6,_7,N,...) N
// NOCC:whitespace/comma(误报:)
